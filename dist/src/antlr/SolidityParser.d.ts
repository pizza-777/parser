...
export declare class SolidityParser extends Parser {
    ...
    static readonly Int = 107;
    static readonly Uint = 108;
    static readonly Byte = 109;
    static readonly Fixed = 110;
    static readonly Ufixed = 111;
    static readonly TvmCell = 112;
    static readonly BooleanLiteral = 113;
    static readonly DecimalNumber = 114;
    static readonly HexNumber = 115;
    static readonly NumberUnit = 116;
    static readonly HexLiteralFragment = 117;
    static readonly ReservedKeyword = 118;
    static readonly AnonymousKeyword = 119;
    static readonly BreakKeyword = 120;
    static readonly ConstantKeyword = 121;
    static readonly ImmutableKeyword = 122;
    static readonly ContinueKeyword = 123;
    static readonly LeaveKeyword = 124;
    static readonly ExternalKeyword = 125;
    static readonly IndexedKeyword = 126;
    static readonly InternalKeyword = 127;
    static readonly PayableKeyword = 128;
    static readonly PrivateKeyword = 129;
    static readonly PublicKeyword = 130;
    static readonly StaticKeyword = 131;
    static readonly VirtualKeyword = 132;
    static readonly PureKeyword = 133;
    static readonly TypeKeyword = 134;
    static readonly ViewKeyword = 135;
    static readonly InlineKeyword = 136;
    static readonly ResponsibleKeyword = 137;
    static readonly ConstructorKeyword = 138;
    static readonly FallbackKeyword = 139;
    static readonly ReceiveKeyword = 140;
    static readonly Identifier = 141;
    static readonly StringLiteralFragment = 142;
    static readonly VersionLiteral = 143;
    static readonly WS = 144;
    static readonly COMMENT = 145;
    static readonly LINE_COMMENT = 146;
    ...
    static readonly RULE_structDefinition = 18;
    static readonly RULE_modifierDefinition = 19;
    static readonly RULE_modifierInvocation = 20;
    static readonly RULE_functionDefinition = 21;
    static readonly RULE_functionDescriptor = 22;
    static readonly RULE_returnParameters = 23;
    static readonly RULE_modifierList = 24;
    static readonly RULE_eventDefinition = 25;
    static readonly RULE_enumValue = 26;
    static readonly RULE_enumDefinition = 27;
    static readonly RULE_parameterList = 28;
    static readonly RULE_parameter = 29;
    static readonly RULE_eventParameterList = 30;
    static readonly RULE_eventParameter = 31;
    static readonly RULE_functionTypeParameterList = 32;
    static readonly RULE_functionTypeParameter = 33;
    static readonly RULE_variableDeclaration = 34;
    static readonly RULE_typeName = 35;
    static readonly RULE_userDefinedTypeName = 36;
    static readonly RULE_mappingKey = 37;
    static readonly RULE_mapping = 38;
    static readonly RULE_functionTypeName = 39;
    static readonly RULE_storageLocation = 40;
    static readonly RULE_stateMutability = 41;
    static readonly RULE_block = 42;
    static readonly RULE_statement = 43;
    static readonly RULE_expressionStatement = 44;
    static readonly RULE_ifStatement = 45;
    ...
    static readonly RULE_optionalTypeName = 66;
    static readonly RULE_expression = 67;
    static readonly RULE_primaryExpression = 68;
    static readonly RULE_nameValueBlockStatement = 69;
    static readonly RULE_expressionList = 70;
    static readonly RULE_nameValueList = 71;
    static readonly RULE_nameValue = 72;
    static readonly RULE_functionCallArguments = 73;
    static readonly RULE_functionCall = 74;
    static readonly RULE_assemblyBlock = 75;
    static readonly RULE_assemblyItem = 76;
    static readonly RULE_assemblyExpression = 77;
    static readonly RULE_assemblyMember = 78;
    static readonly RULE_assemblyCall = 79;
    static readonly RULE_assemblyLocalDefinition = 80;
    static readonly RULE_assemblyAssignment = 81;
    static readonly RULE_assemblyIdentifierOrList = 82;
    static readonly RULE_assemblyIdentifierList = 83;
    static readonly RULE_assemblyStackAssignment = 84;
    static readonly RULE_labelDefinition = 85;
    static readonly RULE_assemblySwitch = 86;
    static readonly RULE_assemblyCase = 87;
    static readonly RULE_assemblyFunctionDefinition = 88;
    static readonly RULE_assemblyFunctionReturns = 89;
    static readonly RULE_assemblyFor = 90;
    static readonly RULE_assemblyIf = 91;
    static readonly RULE_assemblyLiteral = 92;
    static readonly RULE_subAssembly = 93;
    static readonly RULE_tupleExpression = 94;
    static readonly RULE_typeNameExpression = 95;
    static readonly RULE_numberLiteral = 96;
    static readonly RULE_identifier = 97;
    static readonly RULE_hexLiteral = 98;
    static readonly RULE_onBounceKeyword = 99;
    ...
    optionalTypeName(): OptionalTypeNameContext;
    expression(): ExpressionContext;
    expression(_p: number): ExpressionContext;
    primaryExpression(): PrimaryExpressionContext;
    nameValueBlockStatement(): NameValueBlockStatementContext;
...
export declare class ModifierListContext extends ParserRuleContext {
    ...
    ResponsibleKeyword(): TerminalNode[];
    ResponsibleKeyword(i: number): TerminalNode;
    VirtualKeyword(): TerminalNode[];
    VirtualKeyword(i: number): TerminalNode;
    stateMutability(): StateMutabilityContext[];
...
export declare class TypeNameContext extends ParserRuleContext {
    ...
    optionalTypeName(): OptionalTypeNameContext | undefined;
...
export declare class OptionalTypeNameContext extends ParserRuleContext {
    typeName(): TypeNameContext[];
...
export declare class ExpressionContext extends ParserRuleContext {
    ...
    nameValueBlockStatement(): NameValueBlockStatementContext | undefined;
...
export declare class NameValueBlockStatementContext extends ParserRuleContext {
    nameValueList(): NameValueListContext | undefined;
    expressionList(): ExpressionListContext | undefined;
    constructor(parent: ParserRuleContext | undefined, invokingState: number);
    get ruleIndex(): number;
