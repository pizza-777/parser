...
export declare class SolidityParser extends Parser {
    ...
    static readonly ImmutableKeyword = 113;
    static readonly ContinueKeyword = 114;
    static readonly LeaveKeyword = 115;
    static readonly ExternalKeyword = 116;
    static readonly IndexedKeyword = 117;
    static readonly InternalKeyword = 118;
    static readonly PayableKeyword = 119;
    static readonly PrivateKeyword = 120;
    static readonly PublicKeyword = 121;
    static readonly VirtualKeyword = 122;
    static readonly PureKeyword = 123;
    static readonly TypeKeyword = 124;
    static readonly ViewKeyword = 125;
