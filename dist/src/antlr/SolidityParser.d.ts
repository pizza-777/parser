...
export declare class SolidityParser extends Parser {
    ...
    static readonly Int = 109;
    static readonly Uint = 110;
    static readonly Byte = 111;
    static readonly Fixed = 112;
    static readonly Ufixed = 113;
    static readonly TvmCell = 114;
    static readonly BooleanLiteral = 115;
    static readonly DecimalNumber = 116;
    static readonly HexNumber = 117;
    static readonly NumberUnit = 118;
    static readonly HexLiteralFragment = 119;
    static readonly ReservedKeyword = 120;
    static readonly AnonymousKeyword = 121;
    static readonly BreakKeyword = 122;
    static readonly ConstantKeyword = 123;
    static readonly ImmutableKeyword = 124;
    static readonly ContinueKeyword = 125;
    static readonly LeaveKeyword = 126;
    static readonly ExternalKeyword = 127;
    static readonly IndexedKeyword = 128;
    static readonly InternalKeyword = 129;
    static readonly PayableKeyword = 130;
    static readonly PrivateKeyword = 131;
    static readonly PublicKeyword = 132;
    static readonly StaticKeyword = 133;
    static readonly VirtualKeyword = 134;
    static readonly PureKeyword = 135;
    static readonly TypeKeyword = 136;
    static readonly ViewKeyword = 137;
    static readonly InlineKeyword = 138;
    static readonly ResponsibleKeyword = 139;
    static readonly ConstructorKeyword = 140;
    static readonly FallbackKeyword = 141;
    static readonly ReceiveKeyword = 142;
    static readonly Identifier = 143;
    static readonly StringLiteralFragment = 144;
    static readonly VersionLiteral = 145;
    static readonly WS = 146;
    static readonly COMMENT = 147;
    static readonly LINE_COMMENT = 148;
